...
const leftWords = ["My", "You Are My", "Only My"];
labelLeft.innerText = leftWords[Math.floor(Math.random() * leftWords.length)];
...
labelRight.innerText = words[Math.floor(Math.random() * words.length)];
